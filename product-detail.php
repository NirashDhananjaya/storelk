                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li><a id="idContact" href="contact.html">Contact</a></li>
                            <li id="onePointer" style="cursor:pointer;">
                                <a id="idContact" href="cart.php">
                                    <i class="icon-shopping-cart"></i>
                                    <span id="cartNumber"> &nbsp;
                                    Cart[<?php include_once "includes/get_cart_count.php"; ?>]</span></a>
                            </li>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="product-detail-wrap">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="product-entry">
                                    <div class="product-img">
                                        ...
                                        <!--                                                <path d="M144 526 c-70 -31 -98 -106 -69 -182 13 -35 34 -59 88 -102 40 -32-->
                                        <!--91 -76 114 -98 l43 -41 43 41 c23 22 71 64 107 91 78 60 114 120 106 179 -13-->
                                        <!--107 -140 161 -227 97 l-29 -22 -29 22 c-36 27 -106 34 -147 15z"/>-->
                                        <!--                                            </g>-->
                                        <!--                                        </svg>-->
                                        <!---->
                                        ...
                                        $item = selectItemByID($conn, $item_id);
                                        ...
                                        <div id="wowslider-container1">
                                            <div class="ws_images">
                                                <ul>
                                                    <li><img src="images/about.jpg" alt="" title="" id="wows1_0"
                                                             height="100%"
                                                             width="100%"/></li>
                                                    <li><a href=""><img src="images/blog-1.jpg" height="100%"
                                                                        width="100%"
                                                                        alt="bootstrap carousel"
                                                                        title="blog-1"
                                                                        id="wows1_1"/></a>
                                                    </li>
                                                    <li><img src="images/blog-2.jpg" title="blog-2" height="100%"
                                                             width="100%"
                                                             id="wows1_2"/></li>
                                                </ul>
                                            </div>
                                            <div class="ws_bullets">
                                                <div>
                                                    <a href="#" title=""><span><img src="images/about.jpg" alt=""
                                                                                    width="96px" height="72px"/>1</span></a>
                                                    <a href="#" title="blog-1"><span><img src="images/blog-1.jpg"
                                                                                          width="96px" height="72px"/>2</span></a>
                                                    <a href="#" title="blog-2"><span><img src="images/blog-2.jpg"
                                                                                          width="96px" height="72px"/>3</span></a>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="desc">
                                    <h3><?php echo $item[0]['item_title']; ?></h3>
                                    <p class="price">
                                        <span><?php echo $item[0]['price']; ?></span>
                                        <span class="rate text-right">
												...
												(<?php echo $item[0]['rating'] . " out of " .
                                                $item[0]['ratings_out_of']; ?>)
											</span>
                                    </p>
                                    <p><?php echo $item[0]['item_description']; ?></p>
                                    ...
                                    <p id="idAddToCart" class="btn btn-primary btn-addtocart"><i
                                                class="icon-shopping-cart"></i> Add to Cart </p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="js/script_wow.js"></script>
...
//        return;
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                productID: findGetParameter("item_id"),
            ...
            success: function (data) {
                if (String(data) !== null) {
                    // $("#idListCart").text("This field is required.");
                    $("#cartNumber").text("Cart [" + data + "]");
                    // console.log("hello");
                    $(window).scrollTop(0);
                }
            },
