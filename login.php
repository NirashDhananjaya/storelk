            ...
            <div class="logmod__tab-wrapper">
                        ...
                        <form accept-charset="utf-8" action="#" class="simform">
                            <div class="sminputs">
                                <div class="input full">
                                    ...
                                    <input class="string optional" maxlength="255" id="user-email-login"
                                           placeholder="Email"
                                           type="email" size="50"/>
                                </div>
                            </div>
                ...
                <div class="logmod__tab lgm-2">
                    <div class="logmod__heading">
                        <span class="logmod__heading-subtitle">
                            ...
                            if (!isset($_GET['error'])) {
                                ...
                                echo "<strong>" . base64_decode($_GET['error']) . "</strong>";
                            }
                            ?>
                    ...
                    <div class="logmod__form">
                        ...
                        <form accept-charset="utf-8" action="login_submit.php" class="simform" method="post">
                            <div class="sminputs">
                                <div class="input full">
                                    <label class="string optional" for="user-name">Username*</label>
                                    <input class="string optional" maxlength="255" id="username"
                                           required="required" placeholder="Username" name="username"
                                           type="text" size="50"/>
                                </div>
                            </div>
                            <div class="sminputs">
                                <div class="input full">
                                    <label class="string optional" for="user-pw">Password *</label>
                                    <input class="string optional" maxlength="255" id="password" placeholder="Password"
                                           type="password" size="50" name="password" required="required"/>
